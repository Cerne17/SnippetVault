  ...
  return (
    <div className="max-w-md mx-auto mt-12 px-4">
      <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
        <h1 className="text-3xl font-black text-center mb-2 text-slate-900 dark:text-white tracking-tight">Join the Vault</h1>
        <p className="text-slate-500 dark:text-slate-400 text-center mb-8 font-medium">Start curating your digital legacy.</p>
